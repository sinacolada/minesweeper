...
final class MyMouseAdapter extends MouseAdapter {
   ...
   public void mouseClicked(MouseEvent e) {
      ...
      this.currentWorld.processMouseClicked(this.adjustMousePosn(this.mousePosn), this.buttonNameFor(e));
   ...
   public void mousePressed(MouseEvent e) {
      this.currentWorld.stopTimer = true;
      this.mousePosn = new Posn(e.getX(), e.getY());
      this.currentWorld.processMousePressed(this.adjustMousePosn(this.mousePosn), this.buttonNameFor(e));
      this.currentWorld.stopTimer = false;
   }
   ...
   public void mouseReleased(MouseEvent e) {
      this.currentWorld.stopTimer = true;
      this.mousePosn = new Posn(e.getX(), e.getY());
      this.currentWorld.processMouseReleased(this.adjustMousePosn(this.mousePosn), this.buttonNameFor(e));
      this.currentWorld.stopTimer = false;
   }
